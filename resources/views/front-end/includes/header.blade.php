<div class="header">
    <div class="header-top">
        <div class="container">
            <div class="top-left">
                <a href="#"> Help  <i class="glyphicon glyphicon-phone" aria-hidden="true"></i> +880 1686313821</a>
            </div>
            <div class="top-right">
                <ul>
                    ...
                    @else
                        <li><a href="{{ route('new-customer-login') }}">Login & Register</a></li>
                    @endif
        ...
        <div class="container">
            <div class="logo-nav">
                <div class="logo-nav-left">
                    <h1><a href="{{url('/')}}">E-Shop <span>Shop anywhere</span></a></h1>
                </div>
